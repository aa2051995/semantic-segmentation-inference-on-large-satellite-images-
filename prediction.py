...
class PredictionResult:
    def __init__(
        ...
        self.image: Image.Image = image#self.image: Image.Image = read_image_as_pil(image) #
        if not final :
            self.image_width, self.image_height = self.image.shape[0], self.image.shape[1] #self.image_width, self.image_height = self.image.size # self.image_width, self.image_height = self.image.shape[0], self.image.shape[1] 
